  ...
  return (
    `<article class="film-card">
      <a class="film-card__link">
        <h3 class="film-card__title">${he.encode(filmInfo.title)}</h3>
        ...
        <p class="film-card__info">
          ...
          <span class="film-card__genre">${he.encode(filmInfo.genre[0])}</span>
        </p>
        <img src=${filmInfo.poster} alt="" class="film-card__poster">
        <p class="film-card__description">${getPreviewFilmDescription(he.encode(filmInfo.description))}</p>
